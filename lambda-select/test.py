...
# sample = {
#     "statusCode": 200,
#     "body": "{\"user_id\": \"user1234\", \"persona\": \"이 인물은 30대 후반의 남성으로 보입니다. 안경을 쓰고 있어 지적인 이미지를 가지고 있으며, 웃는 표정으로 보아 친근하고 쾌활한 성격을 가지고 있는 것으로 보입니다. 아마도 학문적인 분야에서 일하는 직업을 가지고 있을 것 같습니다.\", \"episode\": [\"어느 날 동료들과 함께 커피를 마시던 중, 새로운 아이디어에 대해 열띤 토론을 벌였습니다. 그는 자신의 아이디어를 설명하며 열정적으로 손짓을 하였고, 결국 그의 아이디어가 채택되었습니다. :짠:\", \"회사에서 새로운 프로젝트가 시작되었을 때, 그는 팀원들에게 새로운 기술을 소개하는 워크숍을 주도하였습니다. 그의 설명은 매우 명확하고 재미있어서 팀원들은 모두 즐겁게 참여하였습니다. :컴퓨터:\", \"퇴근 후 친구들과 함께 게임을 하던 중, 그는 게임에서 승리하여 친구들에게 농담을 하며 웃음을 자아냈습니다. 그의 재치 있는 농담에 친구들은 모두 웃음을 터뜨렸습니다. :비디오_게임:\"]}"
# }
...
def generate_questions(persona, selected_episode, previous_qa=None, question_number=1):
...
persona = "이 인물은 젊은 여성으로 보입니다. 긴 검은 머리카락과 평범한 옷차림으로 보아 학생이나 젊은 직장인일 가능성이 높습니다. 얼굴 표정은 약간 심각하지만 전체적으로 평온한 분위기를 풍깁니다."
episode = [
